  ...
  <body>
    ...
    <div id="body">
      ...
      <div class="body">
        <div>
          <p>
            This website template hahs been designed by
      ...
      <div class="footer">
        ...
        <div class="article">
          ...
          <ul>
            <li>
              <span
                ><a href="blog.html">Aug 00, 2012</a> | by:
                <a href="blog.html">blogger</a></span
              >
              <p>
                This is just a place holder, so you can see what the site would
                look like. <a href="blog.html" class="more">(more)</a>
              </p>
            </li>
            <li>
              <span
